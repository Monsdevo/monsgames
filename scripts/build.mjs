...
for (const file of ["index.html", "bad-haunts.html", "personal.css", "portfolio.css", "portfolio.js", "CNAME", "app-ads.txt", "privacy.html", "privacy-policy.html"]) await cp(resolve(root, file), resolve(dist, "client", file));
